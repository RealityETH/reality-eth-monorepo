...
exports.submitDepositTravelRule = exports.executeFundTransfer = exports.getTransferById = exports.listTransfers = exports.createTransfer = void 0;
 ...
 */
const createTransfer = (transferRequest, options) => {
 ...
 */
const listTransfers = (params, options) => {
    return (0, cdpApiClient_js_1.cdpApiClient)({ url: `/v2/transfers`, method: "GET", params }, options);
};
...
const getTransferById = (transferId, options) => {
    return (0, cdpApiClient_js_1.cdpApiClient)({ url: `/v2/transfers/${transferId}`, method: "GET" }, options);
};
 ...
 */
const executeFundTransfer = (transferId, options) => {
    return (0, cdpApiClient_js_1.cdpApiClient)({ url: `/v2/transfers/${transferId}/execute`, method: "POST" }, options);
};
exports.executeFundTransfer = executeFundTransfer;
/**
 ...
 */
const submitDepositTravelRule = (transferId, depositTravelRuleRequest, options) => {
    return (0, cdpApiClient_js_1.cdpApiClient)({
...
exports.submitDepositTravelRule = submitDepositTravelRule;
