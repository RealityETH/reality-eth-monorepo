 ...
 */
import type { DepositTravelRuleRequest, DepositTravelRuleResponse, ListTransfers200, ListTransfersParams, Transfer, TransferRequest } from "../coinbaseDeveloperPlatformAPIs.schemas.js";
 ...
 */
export declare const createTransfer: (transferRequest: TransferRequest, options?: SecondParameter<typeof cdpApiClient<Transfer>>) => Promise<Transfer>;
/**
 ...
 */
export declare const listTransfers: (params?: ListTransfersParams, options?: SecondParameter<typeof cdpApiClient<ListTransfers200>>) => Promise<ListTransfers200>;
/**
 * Get a transfer by its ID.
 * @summary Get transfer
 */
export declare const getTransferById: (transferId: string, options?: SecondParameter<typeof cdpApiClient<Transfer>>) => Promise<Transfer>;
/**
 * Executes a transfer which was created using the Create a transfer endpoint.
 * @summary Execute transfer
 */
export declare const executeFundTransfer: (transferId: string, options?: SecondParameter<typeof cdpApiClient<Transfer>>) => Promise<Transfer>;
/**
 ...
 */
export declare const submitDepositTravelRule: (transferId: string, depositTravelRuleRequest: DepositTravelRuleRequest, options?: SecondParameter<typeof cdpApiClient<DepositTravelRuleResponse>>) => Promise<DepositTravelRuleResponse>;
...
export type ExecuteFundTransferResult = NonNullable<Awaited<ReturnType<typeof executeFundTransfer>>>;
export type SubmitDepositTravelRuleResult = NonNullable<Awaited<ReturnType<typeof submitDepositTravelRule>>>;
export {};
