...
var M = Object.defineProperty, n = Object.getOwnPropertyDescriptor, l = (a, h, m, Z) => {
  for (var r = Z > 1 ? void 0 : Z ? n(h, m) : h, s = a.length - 1, i; s >= 0; s--)
    (i = a[s]) && (r = (Z ? i(h, m, r) : i(r)) || r);
  return Z && r && M(h, m, r), r;
};
