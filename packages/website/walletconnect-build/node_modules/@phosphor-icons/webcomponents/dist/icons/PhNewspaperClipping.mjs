...
var V = Object.defineProperty, n = Object.getOwnPropertyDescriptor, l = (r, h, o, s) => {
  for (var t = s > 1 ? void 0 : s ? n(h, o) : h, i = r.length - 1, m; i >= 0; i--)
    (m = r[i]) && (t = (s ? m(h, o, t) : m(t)) || t);
  return s && t && V(h, o, t), t;
};
...
a.weightsMap = /* @__PURE__ */ new Map([
  ...
  [
    "duotone",
    e`<path d="M216,48H40a8,8,0,0,0-8,8V216l32-16,32,16,32-16,32,16,32-16,32,16V56A8,8,0,0,0,216,48ZM112,160H64V96h48Z" opacity="0.2"/><path d="M216,40H40A16,16,0,0,0,24,56V216a8,8,0,0,0,11.58,7.15L64,208.94l28.42,14.21a8,8,0,0,0,7.16,0L128,208.94l28.42,14.21a8,8,0,0,0,7.16,0L192,208.94l28.42,14.21A8,8,0,0,0,232,216V56A16,16,0,0,0,216,40Zm0,163.06-20.42-10.22a8,8,0,0,0-7.16,0L160,207.06l-28.42-14.22a8,8,0,0,0-7.16,0L96,207.06,67.58,192.84a8,8,0,0,0-7.16,0L40,203.06V56H216ZM136,112a8,8,0,0,1,8-8h48a8,8,0,0,1,0,16H144A8,8,0,0,1,136,112Zm0,32a8,8,0,0,1,8-8h48a8,8,0,0,1,0,16H144A8,8,0,0,1,136,144ZM64,168h48a8,8,0,0,0,8-8V96a8,8,0,0,0-8-8H64a8,8,0,0,0-8,8v64A8,8,0,0,0,64,168Zm8-64h32v48H72Z"/>`
  ]
]);
a.styles = L`
    :host {
...
a = l([
  Z("ph-newspaper-clipping")
], a);
export {
  a as PhNewspaperClipping
};
