...
var M = Object.defineProperty, c = Object.getOwnPropertyDescriptor, e = (r, s, p, o) => {
  for (var l = o > 1 ? void 0 : o ? c(s, p) : s, i = r.length - 1, m; i >= 0; i--)
    (m = r[i]) && (l = (o ? m(s, p, l) : m(l)) || l);
  return o && l && M(s, p, l), l;
};
