...
var V = Object.defineProperty, M = Object.getOwnPropertyDescriptor, r = (e, v, s, H) => {
  for (var t = H > 1 ? void 0 : H ? M(v, s) : v, i = e.length - 1, Z; i >= 0; i--)
    (Z = e[i]) && (t = (H ? Z(v, s, t) : Z(t)) || t);
