...
var g = Object.defineProperty, L = Object.getOwnPropertyDescriptor, l = (r, o, A, s) => {
  for (var t = s > 1 ? void 0 : s ? L(o, A) : o, p = r.length - 1, i; p >= 0; p--)
    (i = r[p]) && (t = (s ? i(o, A, t) : i(t)) || t);
  return s && t && g(o, A, t), t;
};
