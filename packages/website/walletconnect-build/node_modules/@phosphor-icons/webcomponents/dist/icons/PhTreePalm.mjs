...
var L = Object.defineProperty, c = Object.getOwnPropertyDescriptor, l = (r, o, i, s) => {
  for (var t = s > 1 ? void 0 : s ? c(o, i) : o, A = r.length - 1, h; A >= 0; A--)
    (h = r[A]) && (t = (s ? h(o, i, t) : h(t)) || t);
