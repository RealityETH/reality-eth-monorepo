...
var n = Object.defineProperty, g = Object.getOwnPropertyDescriptor, e = (r, h, s, A) => {
  for (var t = A > 1 ? void 0 : A ? g(h, s) : h, p = r.length - 1, i; p >= 0; p--)
    (i = r[p]) && (t = (A ? i(h, s, t) : i(t)) || t);
  return A && t && n(h, s, t), t;
};
