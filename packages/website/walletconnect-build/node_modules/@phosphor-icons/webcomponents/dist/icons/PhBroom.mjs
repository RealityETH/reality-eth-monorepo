...
var g = Object.defineProperty, M = Object.getOwnPropertyDescriptor, l = (e, o, p, s) => {
  for (var t = s > 1 ? void 0 : s ? M(o, p) : o, c = e.length - 1, A; c >= 0; c--)
    (A = e[c]) && (t = (s ? A(o, p, t) : A(t)) || t);
