...
var c = Object.defineProperty, f = Object.getOwnPropertyDescriptor, s = (r, o, l, i) => {
  for (var t = i > 1 ? void 0 : i ? f(o, l) : o, h = r.length - 1, A; h >= 0; h--)
    (A = r[h]) && (t = (i ? A(o, l, t) : A(t)) || t);
...
a.weightsMap = /* @__PURE__ */ new Map([
  ...
  [
    "bold",
    e`<path d="M220.51,197.94a36,36,0,1,0-57,0,43.75,43.75,0,0,0-15.08,23,12,12,0,0,0,8.52,14.67A11.77,11.77,0,0,0,160,236a12,12,0,0,0,11.59-8.92C174,218.2,182.35,212,192,212s18,6.2,20.4,15.08a12,12,0,0,0,23.19-6.17A43.7,43.7,0,0,0,220.51,197.94ZM192,164a12,12,0,1,1-12,12A12,12,0,0,1,192,164Zm44-76v20a12,12,0,0,1-24,0V92H130.67a20.1,20.1,0,0,1-12-4L92,68H44V196h68a12,12,0,0,1,0,24H40a20,20,0,0,1-20-20V64A20,20,0,0,1,40,44H93.33a20.12,20.12,0,0,1,12,4L132,68h84A20,20,0,0,1,236,88Z"/>`
  ],
  [
    "fill",
    e`<path d="M231.73,221.94A8,8,0,0,1,224,232H160A8,8,0,0,1,152.27,222a40,40,0,0,1,17.11-23.33,32,32,0,1,1,45.24,0A40,40,0,0,1,231.73,221.94ZM216,72H130.67L102.93,51.2a16.12,16.12,0,0,0-9.6-3.2H40A16,16,0,0,0,24,64V200a16,16,0,0,0,16,16h80a8,8,0,0,0,0-16H40V64H93.33l27.74,20.8a16.12,16.12,0,0,0,9.6,3.2H216v32a8,8,0,0,0,16,0V88A16,16,0,0,0,216,72Z"/>`
  ],
  [
    "duotone",
...
a = s([
  n("ph-folder-simple-user")
], a);
export {
  a as PhFolderSimpleUser
};
