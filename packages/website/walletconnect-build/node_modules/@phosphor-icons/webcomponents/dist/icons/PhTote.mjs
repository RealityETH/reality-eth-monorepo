...
var g = Object.defineProperty, Z = Object.getOwnPropertyDescriptor, o = (r, l, i, s) => {
  for (var a = s > 1 ? void 0 : s ? Z(l, i) : l, p = r.length - 1, H; p >= 0; p--)
    (H = r[p]) && (a = (s ? H(l, i, a) : H(a)) || a);
  return s && a && g(l, i, a), a;
};
