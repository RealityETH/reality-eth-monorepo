...
var M = Object.defineProperty, v = Object.getOwnPropertyDescriptor, h = (r, o, A, s) => {
  for (var t = s > 1 ? void 0 : s ? v(o, A) : o, i = r.length - 1, p; i >= 0; i--)
    (p = r[i]) && (t = (s ? p(o, A, t) : p(t)) || t);
  return s && t && M(o, A, t), t;
};
