...
var n = Object.defineProperty, M = Object.getOwnPropertyDescriptor, a = (h, l, m, s) => {
  for (var r = s > 1 ? void 0 : s ? M(l, m) : l, p = h.length - 1, Z; p >= 0; p--)
    (Z = h[p]) && (r = (s ? Z(l, m, r) : Z(r)) || r);
  return s && r && n(l, m, r), r;
};
