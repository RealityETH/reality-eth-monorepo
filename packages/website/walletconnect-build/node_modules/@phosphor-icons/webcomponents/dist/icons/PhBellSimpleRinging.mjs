...
var M = Object.defineProperty, g = Object.getOwnPropertyDescriptor, s = (r, o, h, i) => {
  for (var a = i > 1 ? void 0 : i ? g(o, h) : o, l = r.length - 1, A; l >= 0; l--)
    (A = r[l]) && (a = (i ? A(o, h, a) : A(a)) || a);
  return i && a && M(o, h, a), a;
};
...
t = s([
  c("ph-bell-simple-ringing")
], t);
export {
  t as PhBellSimpleRinging
};
