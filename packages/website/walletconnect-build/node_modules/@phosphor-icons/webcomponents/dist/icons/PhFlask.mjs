...
var M = Object.defineProperty, f = Object.getOwnPropertyDescriptor, h = (a, s, i, l) => {
  for (var r = l > 1 ? void 0 : l ? f(s, i) : s, p = a.length - 1, c; p >= 0; p--)
    (c = a[p]) && (r = (l ? c(s, i, r) : c(r)) || r);
