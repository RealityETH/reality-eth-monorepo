...
var C = Object.defineProperty, f = Object.getOwnPropertyDescriptor, c = (a, o, l, s) => {
  for (var r = s > 1 ? void 0 : s ? f(o, l) : o, p = a.length - 1, h; p >= 0; p--)
    (h = a[p]) && (r = (s ? h(o, l, r) : h(r)) || r);
  return s && r && C(o, l, r), r;
};
