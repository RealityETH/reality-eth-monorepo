...
var n = Object.defineProperty, M = Object.getOwnPropertyDescriptor, l = (e, s, H, o) => {
  for (var a = o > 1 ? void 0 : o ? M(s, H) : s, i = e.length - 1, p; i >= 0; i--)
    (p = e[i]) && (a = (o ? p(s, H, a) : p(a)) || a);
  return o && a && n(s, H, a), a;
};
