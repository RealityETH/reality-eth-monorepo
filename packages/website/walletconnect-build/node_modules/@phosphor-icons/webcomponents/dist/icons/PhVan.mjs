...
var v = Object.defineProperty, M = Object.getOwnPropertyDescriptor, h = (e, H, Z, o) => {
  for (var t = o > 1 ? void 0 : o ? M(H, Z) : H, i = e.length - 1, p; i >= 0; i--)
    (p = e[i]) && (t = (o ? p(H, Z, t) : p(t)) || t);
  return o && t && v(H, Z, t), t;
};
