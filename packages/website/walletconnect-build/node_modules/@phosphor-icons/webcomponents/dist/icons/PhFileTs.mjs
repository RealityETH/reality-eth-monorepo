...
var Z = Object.defineProperty, M = Object.getOwnPropertyDescriptor, s = (r, c, i, h) => {
  for (var t = h > 1 ? void 0 : h ? M(c, i) : c, l = r.length - 1, p; l >= 0; l--)
    (p = r[l]) && (t = (h ? p(c, i, t) : p(t)) || t);
  return h && t && Z(c, i, t), t;
};
