...
var n = Object.defineProperty, M = Object.getOwnPropertyDescriptor, h = (r, o, l, s) => {
  for (var a = s > 1 ? void 0 : s ? M(o, l) : o, p = r.length - 1, m; p >= 0; p--)
    (m = r[p]) && (a = (s ? m(o, l, a) : m(a)) || a);
...
t.weightsMap = /* @__PURE__ */ new Map([
  ...
  [
    "fill",
    e`<path d="M213.66,82.34l-56-56A8,8,0,0,0,152,24H56A16,16,0,0,0,40,40V216a16,16,0,0,0,16,16H200a16,16,0,0,0,16-16V88A8,8,0,0,0,213.66,82.34ZM160,176H96a8,8,0,0,1,0-16h64a8,8,0,0,1,0,16Zm0-32H96a8,8,0,0,1,0-16h64a8,8,0,0,1,0,16Zm-8-56V44l44,44Z"/>`
  ],
  [
    "duotone",
