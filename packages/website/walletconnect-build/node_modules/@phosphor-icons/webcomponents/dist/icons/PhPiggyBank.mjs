...
var Z = Object.defineProperty, c = Object.getOwnPropertyDescriptor, e = (r, l, s, A) => {
  for (var t = A > 1 ? void 0 : A ? c(l, s) : l, H = r.length - 1, i; H >= 0; H--)
    (i = r[H]) && (t = (A ? i(l, s, t) : i(t)) || t);
  return A && t && Z(l, s, t), t;
};
