...
var n = Object.defineProperty, Z = Object.getOwnPropertyDescriptor, l = (e, H, h, o) => {
  for (var t = o > 1 ? void 0 : o ? Z(H, h) : H, i = e.length - 1, p; i >= 0; i--)
    (p = e[i]) && (t = (o ? p(H, h, t) : p(t)) || t);
  return o && t && n(H, h, t), t;
};
