...
var g = Object.defineProperty, f = Object.getOwnPropertyDescriptor, h = (a, s, p, o) => {
  for (var r = o > 1 ? void 0 : o ? f(s, p) : s, l = a.length - 1, A; l >= 0; l--)
    (A = a[l]) && (r = (o ? A(s, p, r) : A(r)) || r);
  return o && r && g(s, p, r), r;
};
