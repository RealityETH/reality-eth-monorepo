...
var A = Object.defineProperty, f = Object.getOwnPropertyDescriptor, l = (r, o, m, Z) => {
  for (var t = Z > 1 ? void 0 : Z ? f(o, m) : o, i = r.length - 1, p; i >= 0; i--)
    (p = r[i]) && (t = (Z ? p(o, m, t) : p(t)) || t);
  return Z && t && A(o, m, t), t;
};
