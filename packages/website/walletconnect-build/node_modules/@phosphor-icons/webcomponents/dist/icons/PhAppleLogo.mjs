...
var C = Object.defineProperty, Z = Object.getOwnPropertyDescriptor, h = (r, o, p, s) => {
  for (var t = s > 1 ? void 0 : s ? Z(o, p) : o, i = r.length - 1, l; i >= 0; i--)
    (l = r[i]) && (t = (s ? l(o, p, t) : l(t)) || t);
