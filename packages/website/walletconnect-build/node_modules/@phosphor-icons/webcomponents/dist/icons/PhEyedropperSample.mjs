...
var g = Object.defineProperty, A = Object.getOwnPropertyDescriptor, r = (e, o, h, s) => {
  for (var l = s > 1 ? void 0 : s ? A(o, h) : o, i = e.length - 1, m; i >= 0; i--)
    (m = e[i]) && (l = (s ? m(o, h, l) : m(l)) || l);
  return s && l && g(o, h, l), l;
};
...
a = r([
  Z("ph-eyedropper-sample")
], a);
export {
  a as PhEyedropperSample
};
