...
var M = Object.defineProperty, Z = Object.getOwnPropertyDescriptor, o = (a, h, p, l) => {
  for (var e = l > 1 ? void 0 : l ? Z(h, p) : h, i = a.length - 1, c; i >= 0; i--)
    (c = a[i]) && (e = (l ? c(h, p, e) : c(e)) || e);
  return l && e && M(h, p, e), e;
};
