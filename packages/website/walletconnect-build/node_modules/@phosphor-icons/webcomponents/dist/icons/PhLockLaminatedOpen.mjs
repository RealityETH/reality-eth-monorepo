...
var n = Object.defineProperty, c = Object.getOwnPropertyDescriptor, H = (a, o, p, s) => {
  for (var e = s > 1 ? void 0 : s ? c(o, p) : o, V = a.length - 1, l; V >= 0; V--)
    (l = a[V]) && (e = (s ? l(o, p, e) : l(e)) || e);
...
t.weightsMap = /* @__PURE__ */ new Map([
  ...
  [
    "regular",
    r`<path d="M208,80H96V56a32,32,0,0,1,32-32c15.37,0,29.2,11,32.16,25.59a8,8,0,0,0,15.68-3.18C171.32,24.15,151.2,8,128,8A48.05,48.05,0,0,0,80,56V80H48A16,16,0,0,0,32,96V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V96A16,16,0,0,0,208,80ZM48,128H208v16H48Zm0,32H208v16H48ZM208,96v16H48V96Zm0,112H48V192H208v16Z"/>`
  ],
  [
    "bold",
    r`<path d="M208,76H100V56a28,28,0,0,1,28-28c13.51,0,25.65,9.62,28.24,22.39a12,12,0,1,0,23.52-4.78C174.87,21.5,153.1,4,128,4A52.06,52.06,0,0,0,76,56V76H48A20,20,0,0,0,28,96V208a20,20,0,0,0,20,20H208a20,20,0,0,0,20-20V96A20,20,0,0,0,208,76ZM52,144H204v16H52Zm152-44v20H52V100ZM52,204V184H204v20Z"/>`
  ],
  [
    "fill",
...
t = H([
  v("ph-lock-laminated-open")
], t);
export {
  t as PhLockLaminatedOpen
};
