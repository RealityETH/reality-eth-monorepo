...
var g = Object.defineProperty, f = Object.getOwnPropertyDescriptor, l = (a, s, p, o) => {
  for (var e = o > 1 ? void 0 : o ? f(s, p) : s, h = a.length - 1, m; h >= 0; h--)
...
t.weightsMap = /* @__PURE__ */ new Map([
  ...
  [
    "fill",
    r`<path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,40a16,16,0,1,1-16,16A16,16,0,0,1,128,64Zm48,56H136v13.58l30.66,46a8,8,0,0,1-13.32,8.88l-25.34-38-25.34,38a8,8,0,1,1-13.32-8.88l30.66-46V120H80a8,8,0,0,1,0-16h96a8,8,0,0,1,0,16Z"/>`
  ],
  [
    "duotone",
...
t = l([
  Z("ph-person-simple-circle")
], t);
export {
  t as PhPersonSimpleCircle
};
