...
var g = Object.defineProperty, u = Object.getOwnPropertyDescriptor, s = (e, o, h, i) => {
  for (var r = i > 1 ? void 0 : i ? u(o, h) : o, A = e.length - 1, l; A >= 0; A--)
    (l = e[A]) && (r = (i ? l(o, h, r) : l(r)) || r);
...
t = s([
  Z("ph-user-circle-minus")
], t);
export {
  t as PhUserCircleMinus
};
