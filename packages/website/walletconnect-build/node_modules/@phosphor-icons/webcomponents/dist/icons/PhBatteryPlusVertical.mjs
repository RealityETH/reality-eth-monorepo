...
var Z = Object.defineProperty, n = Object.getOwnPropertyDescriptor, h = (e, s, p, o) => {
  for (var t = o > 1 ? void 0 : o ? n(s, p) : s, l = e.length - 1, m; l >= 0; l--)
    (m = e[l]) && (t = (o ? m(s, p, t) : m(t)) || t);
  return o && t && Z(s, p, t), t;
};
...
a.weightsMap = /* @__PURE__ */ new Map([
  ...
  [
    "regular",
    r`<path d="M88,8a8,8,0,0,1,8-8h64a8,8,0,0,1,0,16H96A8,8,0,0,1,88,8ZM200,56V224a24,24,0,0,1-24,24H80a24,24,0,0,1-24-24V56A24,24,0,0,1,80,32h96A24,24,0,0,1,200,56Zm-16,0a8,8,0,0,0-8-8H80a8,8,0,0,0-8,8V224a8,8,0,0,0,8,8h96a8,8,0,0,0,8-8Zm-28,76H136V112a8,8,0,0,0-16,0v20H100a8,8,0,0,0,0,16h20v20a8,8,0,0,0,16,0V148h20a8,8,0,0,0,0-16Z"/>`
  ],
  [
    "bold",
  ...
  [
    "fill",
    r`<path d="M88,8a8,8,0,0,1,8-8h64a8,8,0,0,1,0,16H96A8,8,0,0,1,88,8ZM200,56V224a24,24,0,0,1-24,24H80a24,24,0,0,1-24-24V56A24,24,0,0,1,80,32h96A24,24,0,0,1,200,56Zm-36,84a8,8,0,0,0-8-8H136V112a8,8,0,0,0-16,0v20H100a8,8,0,0,0,0,16h20v20a8,8,0,0,0,16,0V148h20A8,8,0,0,0,164,140Z"/>`
  ],
  [
    "duotone",
...
a = h([
  v("ph-battery-plus-vertical")
], a);
export {
  a as PhBatteryPlusVertical
};
