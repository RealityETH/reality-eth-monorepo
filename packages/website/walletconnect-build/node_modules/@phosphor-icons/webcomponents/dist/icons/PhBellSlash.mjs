...
var M = Object.defineProperty, g = Object.getOwnPropertyDescriptor, s = (r, o, i, h) => {
  for (var a = h > 1 ? void 0 : h ? g(o, i) : o, p = r.length - 1, A; p >= 0; p--)
    (A = r[p]) && (a = (h ? A(o, i, a) : A(a)) || a);
  return h && a && M(o, i, a), a;
};
