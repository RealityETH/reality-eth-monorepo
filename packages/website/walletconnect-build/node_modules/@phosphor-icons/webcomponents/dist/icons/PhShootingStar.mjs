...
var A = Object.defineProperty, c = Object.getOwnPropertyDescriptor, e = (r, o, i, s) => {
  for (var l = s > 1 ? void 0 : s ? c(o, i) : o, p = r.length - 1, m; p >= 0; p--)
    (m = r[p]) && (l = (s ? m(o, i, l) : m(l)) || l);
