...
var C = Object.defineProperty, n = Object.getOwnPropertyDescriptor, e = (r, s, i, o) => {
  for (var t = o > 1 ? void 0 : o ? n(s, i) : s, A = r.length - 1, h; A >= 0; A--)
    (h = r[A]) && (t = (o ? h(s, i, t) : h(t)) || t);
