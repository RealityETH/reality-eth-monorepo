...
var V = Object.defineProperty, M = Object.getOwnPropertyDescriptor, r = (e, v, H, o) => {
  for (var t = o > 1 ? void 0 : o ? M(v, H) : v, A = e.length - 1, p; A >= 0; A--)
    (p = e[A]) && (t = (o ? p(v, H, t) : p(t)) || t);
  return o && t && V(v, H, t), t;
};
