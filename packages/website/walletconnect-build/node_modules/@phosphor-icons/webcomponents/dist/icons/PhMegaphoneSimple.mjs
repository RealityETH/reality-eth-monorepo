...
var g = Object.defineProperty, v = Object.getOwnPropertyDescriptor, l = (a, o, i, s) => {
  for (var e = s > 1 ? void 0 : s ? v(o, i) : o, h = a.length - 1, V; h >= 0; h--)
    (V = a[h]) && (e = (s ? V(o, i, e) : V(e)) || e);
...
t = l([
  A("ph-megaphone-simple")
], t);
export {
  t as PhMegaphoneSimple
};
