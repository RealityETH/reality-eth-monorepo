...
var m = Object.defineProperty, g = Object.getOwnPropertyDescriptor, o = (r, s, p, l) => {
  for (var a = l > 1 ? void 0 : l ? g(s, p) : s, A = r.length - 1, h; A >= 0; A--)
    (h = r[A]) && (a = (l ? h(s, p, a) : h(a)) || a);
  return l && a && m(s, p, a), a;
};
