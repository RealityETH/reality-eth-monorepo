...
var f = Object.defineProperty, d = Object.getOwnPropertyDescriptor, s = (a, o, i, p) => {
  for (var e = p > 1 ? void 0 : p ? d(o, i) : o, l = a.length - 1, h; l >= 0; l--)
    (h = a[l]) && (e = (p ? h(o, i, e) : h(e)) || e);
  return p && e && f(o, i, e), e;
};
...
t = s([
  g("ph-approximate-equals")
], t);
export {
  t as PhApproximateEquals
};
