...
var V = Object.defineProperty, n = Object.getOwnPropertyDescriptor, c = (s, o, p, C) => {
  for (var r = C > 1 ? void 0 : C ? n(o, p) : o, a = s.length - 1, m; a >= 0; a--)
    (m = s[a]) && (r = (C ? m(o, p, r) : m(r)) || r);
  return C && r && V(o, p, r), r;
};
