...
var V = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = (h, e, s, l) => {
  for (var H = l > 1 ? void 0 : l ? n(e, s) : e, Z = h.length - 1, i; Z >= 0; Z--)
    (i = h[Z]) && (H = (l ? i(e, s, H) : i(H)) || H);
  return l && H && V(e, s, H), H;
};
