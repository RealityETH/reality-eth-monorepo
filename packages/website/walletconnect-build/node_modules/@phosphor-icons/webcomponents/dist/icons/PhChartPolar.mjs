...
var V = Object.defineProperty, v = Object.getOwnPropertyDescriptor, Z = (e, o, m, s) => {
  for (var A = s > 1 ? void 0 : s ? v(o, m) : o, p = e.length - 1, i; p >= 0; p--)
    (i = e[p]) && (A = (s ? i(o, m, A) : i(A)) || A);
  return s && A && V(o, m, A), A;
};
