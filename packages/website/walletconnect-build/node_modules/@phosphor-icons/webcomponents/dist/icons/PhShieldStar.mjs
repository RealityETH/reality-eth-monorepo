...
var n = Object.defineProperty, g = Object.getOwnPropertyDescriptor, l = (a, s, p, o) => {
  for (var r = o > 1 ? void 0 : o ? g(s, p) : s, c = a.length - 1, h; c >= 0; c--)
    (h = a[c]) && (r = (o ? h(s, p, r) : h(r)) || r);
  return o && r && n(s, p, r), r;
};
