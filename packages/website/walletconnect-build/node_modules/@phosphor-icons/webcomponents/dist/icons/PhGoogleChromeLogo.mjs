...
var n = Object.defineProperty, f = Object.getOwnPropertyDescriptor, o = (a, s, i, l) => {
  for (var e = l > 1 ? void 0 : l ? f(s, i) : s, p = a.length - 1, h; p >= 0; p--)
    (h = a[p]) && (e = (l ? h(s, i, e) : h(e)) || e);
  return l && e && n(s, i, e), e;
};
...
t = o([
  Z("ph-google-chrome-logo")
], t);
export {
  t as PhGoogleChromeLogo
};
