...
var g = Object.defineProperty, Z = Object.getOwnPropertyDescriptor, r = (l, o, i, s) => {
  for (var t = s > 1 ? void 0 : s ? Z(o, i) : o, h = l.length - 1, m; h >= 0; h--)
    (m = l[h]) && (t = (s ? m(o, i, t) : m(t)) || t);
...
a.weightsMap = /* @__PURE__ */ new Map([
  ...
  [
    "light",
    e`<path d="M26,128A70.08,70.08,0,0,1,96,58H209.51L195.76,44.24a6,6,0,0,1,8.48-8.48l24,24a6,6,0,0,1,0,8.48l-24,24a6,6,0,0,1-8.48-8.48L209.51,70H96a58.07,58.07,0,0,0-58,58,6,6,0,0,1-12,0Zm198-6a6,6,0,0,0-6,6,58.07,58.07,0,0,1-58,58H46.49l13.75-13.76a6,6,0,0,0-8.48-8.48l-24,24a6,6,0,0,0,0,8.48l24,24a6,6,0,0,0,8.48-8.48L46.49,198H160a70.08,70.08,0,0,0,70-70A6,6,0,0,0,224,122Zm-88,36a6,6,0,0,0,6-6V104a6,6,0,0,0-8.68-5.37l-16,8a6,6,0,1,0,5.36,10.73L130,113.7V152A6,6,0,0,0,136,158Z"/>`
  ],
  [
    "regular",
