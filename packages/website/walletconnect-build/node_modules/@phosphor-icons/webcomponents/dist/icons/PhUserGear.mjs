...
var g = Object.defineProperty, M = Object.getOwnPropertyDescriptor, l = (e, s, p, o) => {
  for (var t = o > 1 ? void 0 : o ? M(s, p) : s, h = e.length - 1, m; h >= 0; h--)
    (m = e[h]) && (t = (o ? m(s, p, t) : m(t)) || t);
