...
var n = Object.defineProperty, M = Object.getOwnPropertyDescriptor, a = (e, o, i, s) => {
  for (var l = s > 1 ? void 0 : s ? M(o, i) : o, p = e.length - 1, h; p >= 0; p--)
    (h = e[p]) && (l = (s ? h(o, i, l) : h(l)) || l);
  return s && l && n(o, i, l), l;
};
