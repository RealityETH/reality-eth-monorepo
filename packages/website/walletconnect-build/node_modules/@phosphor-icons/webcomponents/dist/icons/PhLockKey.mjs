...
var n = Object.defineProperty, M = Object.getOwnPropertyDescriptor, o = (r, V, p, s) => {
  for (var a = s > 1 ? void 0 : s ? M(V, p) : V, H = r.length - 1, l; H >= 0; H--)
    (l = r[H]) && (a = (s ? l(V, p, a) : l(a)) || a);
  return s && a && n(V, p, a), a;
};
