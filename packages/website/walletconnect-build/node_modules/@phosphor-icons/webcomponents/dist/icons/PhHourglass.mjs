...
var g = Object.defineProperty, L = Object.getOwnPropertyDescriptor, s = (e, o, p, l) => {
  for (var a = l > 1 ? void 0 : l ? L(o, p) : o, h = e.length - 1, V; h >= 0; h--)
    (V = e[h]) && (a = (l ? V(o, p, a) : V(a)) || a);
