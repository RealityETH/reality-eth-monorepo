...
var Z = Object.defineProperty, v = Object.getOwnPropertyDescriptor, e = (l, o, p, s) => {
  for (var t = s > 1 ? void 0 : s ? v(o, p) : o, i = l.length - 1, h; i >= 0; i--)
    (h = l[i]) && (t = (s ? h(o, p, t) : h(t)) || t);
