...
var v = Object.defineProperty, Z = Object.getOwnPropertyDescriptor, s = (r, o, p, c) => {
  for (var t = c > 1 ? void 0 : c ? Z(o, p) : o, V = r.length - 1, h; V >= 0; V--)
    (h = r[V]) && (t = (c ? h(o, p, t) : h(t)) || t);
  return c && t && v(o, p, t), t;
};
