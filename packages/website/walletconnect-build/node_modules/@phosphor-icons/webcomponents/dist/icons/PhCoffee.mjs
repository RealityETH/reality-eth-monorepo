...
var v = Object.defineProperty, n = Object.getOwnPropertyDescriptor, o = (r, V, i, s) => {
  for (var t = s > 1 ? void 0 : s ? n(V, i) : V, p = r.length - 1, h; p >= 0; p--)
    (h = r[p]) && (t = (s ? h(V, i, t) : h(t)) || t);
  return s && t && v(V, i, t), t;
};
