...
var H = Object.defineProperty, V = Object.getOwnPropertyDescriptor, l = (r, c, i, s) => {
  for (var t = s > 1 ? void 0 : s ? V(c, i) : c, p = r.length - 1, h; p >= 0; p--)
    (h = r[p]) && (t = (s ? h(c, i, t) : h(t)) || t);
  return s && t && H(c, i, t), t;
};
