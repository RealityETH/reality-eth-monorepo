...
var u = Object.defineProperty, f = Object.getOwnPropertyDescriptor, e = (c, s, p, o) => {
  for (var a = o > 1 ? void 0 : o ? f(s, p) : s, l = c.length - 1, h; l >= 0; l--)
    (h = c[l]) && (a = (o ? h(s, p, a) : h(a)) || a);
  return o && a && u(s, p, a), a;
};
