...
var Z = Object.defineProperty, M = Object.getOwnPropertyDescriptor, s = (a, h, l, o) => {
  for (var e = o > 1 ? void 0 : o ? M(h, l) : h, p = a.length - 1, m; p >= 0; p--)
    (m = a[p]) && (e = (o ? m(h, l, e) : m(e)) || e);
  return o && e && Z(h, l, e), e;
};
...
t.weightsMap = /* @__PURE__ */ new Map([
  ...
  [
    "regular",
    r`<path d="M213.66,82.34l-56-56A8,8,0,0,0,152,24H56A16,16,0,0,0,40,40V216a16,16,0,0,0,16,16H200a16,16,0,0,0,16-16V88A8,8,0,0,0,213.66,82.34ZM160,51.31,188.69,80H160ZM200,216H56V40h88V88a8,8,0,0,0,8,8h48V216Zm-40-64a8,8,0,0,1-8,8H104a8,8,0,0,1,0-16h48A8,8,0,0,1,160,152Z"/>`
  ],
  [
    "bold",
    r`<path d="M216.49,79.51l-56-56A12,12,0,0,0,152,20H56A20,20,0,0,0,36,40V216a20,20,0,0,0,20,20H200a20,20,0,0,0,20-20V88A12,12,0,0,0,216.49,79.51ZM160,57l23,23H160ZM60,212V44h76V92a12,12,0,0,0,12,12h48V212Zm104-60a12,12,0,0,1-12,12H104a12,12,0,0,1,0-24h48A12,12,0,0,1,164,152Z"/>`
  ],
  [
    "fill",
    r`<path d="M213.66,82.34l-56-56A8,8,0,0,0,152,24H56A16,16,0,0,0,40,40V216a16,16,0,0,0,16,16H200a16,16,0,0,0,16-16V88A8,8,0,0,0,213.66,82.34ZM152,160H104a8,8,0,0,1,0-16h48a8,8,0,0,1,0,16Zm0-72V43.31L196.69,88Z"/>`
  ],
  [
    "duotone",
