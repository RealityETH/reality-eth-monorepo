...
var n = Object.defineProperty, A = Object.getOwnPropertyDescriptor, h = (r, l, i, o) => {
  for (var t = o > 1 ? void 0 : o ? A(l, i) : l, V = r.length - 1, p; V >= 0; V--)
    (p = r[V]) && (t = (o ? p(l, i, t) : p(t)) || t);
  return o && t && n(l, i, t), t;
};
