...
var M = Object.defineProperty, A = Object.getOwnPropertyDescriptor, a = (l, o, i, s) => {
  for (var e = s > 1 ? void 0 : s ? A(o, i) : o, h = l.length - 1, m; h >= 0; h--)
    (m = l[h]) && (e = (s ? m(o, i, e) : m(e)) || e);
  return s && e && M(o, i, e), e;
};
