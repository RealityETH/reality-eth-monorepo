...
var M = Object.defineProperty, g = Object.getOwnPropertyDescriptor, r = (e, L, A, o) => {
  for (var a = o > 1 ? void 0 : o ? g(L, A) : L, m = e.length - 1, p; m >= 0; m--)
    (p = e[m]) && (a = (o ? p(L, A, a) : p(a)) || a);
  return o && a && M(L, A, a), a;
};
...
l = r([
  h("ph-plugs-connected")
], l);
export {
  l as PhPlugsConnected
};
