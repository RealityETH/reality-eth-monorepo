...
var c = Object.defineProperty, f = Object.getOwnPropertyDescriptor, h = (r, o, l, s) => {
  for (var t = s > 1 ? void 0 : s ? f(o, l) : o, p = r.length - 1, m; p >= 0; p--)
    (m = r[p]) && (t = (s ? m(o, l, t) : m(t)) || t);
  return s && t && c(o, l, t), t;
};
...
a = h([
  n("ph-lightbulb-filament")
], a);
export {
  a as PhLightbulbFilament
};
