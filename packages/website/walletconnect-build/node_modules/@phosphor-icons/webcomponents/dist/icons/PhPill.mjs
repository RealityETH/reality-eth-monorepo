...
var L = Object.defineProperty, c = Object.getOwnPropertyDescriptor, l = (a, o, p, s) => {
  for (var r = s > 1 ? void 0 : s ? c(o, p) : o, h = a.length - 1, m; h >= 0; h--)
    (m = a[h]) && (r = (s ? m(o, p, r) : m(r)) || r);
  return s && r && L(o, p, r), r;
};
