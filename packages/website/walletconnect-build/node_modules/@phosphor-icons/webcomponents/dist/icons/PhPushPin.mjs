...
var g = Object.defineProperty, u = Object.getOwnPropertyDescriptor, l = (a, s, i, o) => {
  for (var r = o > 1 ? void 0 : o ? u(s, i) : s, p = a.length - 1, h; p >= 0; p--)
    (h = a[p]) && (r = (o ? h(s, i, r) : h(r)) || r);
  return o && r && g(s, i, r), r;
};
