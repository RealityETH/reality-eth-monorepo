...
var v = Object.defineProperty, g = Object.getOwnPropertyDescriptor, l = (r, s, c, o) => {
  for (var t = o > 1 ? void 0 : o ? g(s, c) : s, i = r.length - 1, h; i >= 0; i--)
    (h = r[i]) && (t = (o ? h(s, c, t) : h(t)) || t);
  return o && t && v(s, c, t), t;
};
