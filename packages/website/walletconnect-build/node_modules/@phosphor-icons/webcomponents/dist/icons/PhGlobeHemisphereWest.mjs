...
var M = Object.defineProperty, g = Object.getOwnPropertyDescriptor, r = (e, h, i, s) => {
  for (var a = s > 1 ? void 0 : s ? g(h, i) : h, p = e.length - 1, A; p >= 0; p--)
    (A = e[p]) && (a = (s ? A(h, i, a) : A(a)) || a);
  return s && a && M(h, i, a), a;
};
...
l = r([
  Z("ph-globe-hemisphere-west")
], l);
export {
  l as PhGlobeHemisphereWest
};
