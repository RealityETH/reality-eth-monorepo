...
var Z = Object.defineProperty, n = Object.getOwnPropertyDescriptor, s = (r, o, l, i) => {
  for (var a = i > 1 ? void 0 : i ? n(o, l) : o, h = r.length - 1, m; h >= 0; h--)
    (m = r[h]) && (a = (i ? m(o, l, a) : m(a)) || a);
  return i && a && Z(o, l, a), a;
};
...
t = s([
  A("ph-speaker-simple-high")
], t);
export {
  t as PhSpeakerSimpleHigh
};
