...
var g = Object.defineProperty, f = Object.getOwnPropertyDescriptor, a = (e, o, p, s) => {
  for (var l = s > 1 ? void 0 : s ? f(o, p) : o, h = e.length - 1, L; h >= 0; h--)
    (L = e[h]) && (l = (s ? L(o, p, l) : L(l)) || l);
  return s && l && g(o, p, l), l;
};
