...
var f = Object.defineProperty, Z = Object.getOwnPropertyDescriptor, l = (a, s, i, o) => {
  for (var e = o > 1 ? void 0 : o ? Z(s, i) : s, c = a.length - 1, m; c >= 0; c--)
    (m = a[c]) && (e = (o ? m(s, i, e) : m(e)) || e);
...
t = l([
  n("ph-person-simple-walk")
], t);
export {
  t as PhPersonSimpleWalk
};
