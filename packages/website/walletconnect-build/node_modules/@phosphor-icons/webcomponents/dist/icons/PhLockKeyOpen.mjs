...
var n = Object.defineProperty, Z = Object.getOwnPropertyDescriptor, o = (r, s, i, V) => {
  for (var t = V > 1 ? void 0 : V ? Z(s, i) : s, m = r.length - 1, l; m >= 0; m--)
    (l = r[m]) && (t = (V ? l(s, i, t) : l(t)) || t);
  return V && t && n(s, i, t), t;
};
