...
var f = Object.defineProperty, g = Object.getOwnPropertyDescriptor, l = (e, s, i, c) => {
  for (var t = c > 1 ? void 0 : c ? g(s, i) : s, p = e.length - 1, h; p >= 0; p--)
    (h = e[p]) && (t = (c ? h(s, i, t) : h(t)) || t);
  return c && t && f(s, i, t), t;
};
