...
var g = Object.defineProperty, f = Object.getOwnPropertyDescriptor, l = (e, s, c, o) => {
  for (var a = o > 1 ? void 0 : o ? f(s, c) : s, i = e.length - 1, h; i >= 0; i--)
    (h = e[i]) && (a = (o ? h(s, c, a) : h(a)) || a);
  return o && a && g(s, c, a), a;
};
...
t = l([
  n("ph-person-simple-throw")
], t);
export {
  t as PhPersonSimpleThrow
};
