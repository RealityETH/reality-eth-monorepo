...
var g = Object.defineProperty, f = Object.getOwnPropertyDescriptor, l = (a, o, p, s) => {
  for (var r = s > 1 ? void 0 : s ? f(o, p) : o, m = a.length - 1, h; m >= 0; m--)
    (h = a[m]) && (r = (s ? h(o, p, r) : h(r)) || r);
  return s && r && g(o, p, r), r;
};
...
t = l([
  c("ph-caret-circle-up-down")
], t);
export {
  t as PhCaretCircleUpDown
};
