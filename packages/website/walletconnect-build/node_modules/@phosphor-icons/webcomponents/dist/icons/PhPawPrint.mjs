...
var g = Object.defineProperty, c = Object.getOwnPropertyDescriptor, A = (e, Z, s, m) => {
  for (var t = m > 1 ? void 0 : m ? c(Z, s) : Z, i = e.length - 1, p; i >= 0; i--)
    (p = e[i]) && (t = (m ? p(Z, s, t) : p(t)) || t);
  return m && t && g(Z, s, t), t;
};
