...
var g = Object.defineProperty, f = Object.getOwnPropertyDescriptor, h = (e, o, i, s) => {
  for (var t = s > 1 ? void 0 : s ? f(o, i) : o, p = e.length - 1, m; p >= 0; p--)
...
a = h([
  v("ph-arrow-fat-lines-up")
], a);
export {
  a as PhArrowFatLinesUp
};
