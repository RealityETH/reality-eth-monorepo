...
var n = Object.defineProperty, v = Object.getOwnPropertyDescriptor, h = (r, s, i, o) => {
  for (var a = o > 1 ? void 0 : o ? v(s, i) : s, p = r.length - 1, V; p >= 0; p--)
    (V = r[p]) && (a = (o ? V(s, i, a) : V(a)) || a);
...
t.weightsMap = /* @__PURE__ */ new Map([
  ...
  [
    "fill",
    e`<path d="M213.66,82.34l-56-56A8,8,0,0,0,152,24H56A16,16,0,0,0,40,40V216a16,16,0,0,0,16,16H200a16,16,0,0,0,16-16V88A8,8,0,0,0,213.66,82.34ZM152,160H136v16a8,8,0,0,1-16,0V160H104a8,8,0,0,1,0-16h16V128a8,8,0,0,1,16,0v16h16a8,8,0,0,1,0,16Zm0-72V43.31L196.69,88Z"/>`
  ],
  [
    "duotone",
