...
var M = Object.defineProperty, g = Object.getOwnPropertyDescriptor, o = (r, i, h, s) => {
  for (var a = s > 1 ? void 0 : s ? g(i, h) : i, A = r.length - 1, l; A >= 0; A--)
    (l = r[A]) && (a = (s ? l(i, h, a) : l(a)) || a);
  return s && a && M(i, h, a), a;
};
...
t = o([
  H("ph-identification-badge")
], t);
export {
  t as PhIdentificationBadge
};
