...
var c = Object.defineProperty, M = Object.getOwnPropertyDescriptor, l = (e, o, p, s) => {
  for (var t = s > 1 ? void 0 : s ? M(o, p) : o, A = e.length - 1, h; A >= 0; A--)
...
a = l([
  n("ph-microphone-slash")
], a);
export {
  a as PhMicrophoneSlash
};
