...
var n = Object.defineProperty, v = Object.getOwnPropertyDescriptor, a = (e, o, i, c) => {
  for (var s = c > 1 ? void 0 : c ? v(o, i) : o, m = e.length - 1, A; m >= 0; m--)
    (A = e[m]) && (s = (c ? A(o, i, s) : A(s)) || s);
  return c && s && n(o, i, s), s;
};
