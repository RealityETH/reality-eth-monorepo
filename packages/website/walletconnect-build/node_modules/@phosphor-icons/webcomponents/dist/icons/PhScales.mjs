...
var g = Object.defineProperty, Z = Object.getOwnPropertyDescriptor, s = (r, l, c, h) => {
  for (var a = h > 1 ? void 0 : h ? Z(l, c) : l, i = r.length - 1, p; i >= 0; i--)
    (p = r[i]) && (a = (h ? p(l, c, a) : p(a)) || a);
  return h && a && g(l, c, a), a;
};
