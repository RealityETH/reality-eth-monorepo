...
var Z = Object.defineProperty, u = Object.getOwnPropertyDescriptor, o = (a, s, l, p) => {
  for (var r = p > 1 ? void 0 : p ? u(s, l) : s, h = a.length - 1, c; h >= 0; h--)
    (c = a[h]) && (r = (p ? c(s, l, r) : c(r)) || r);
  return p && r && Z(s, l, r), r;
};
