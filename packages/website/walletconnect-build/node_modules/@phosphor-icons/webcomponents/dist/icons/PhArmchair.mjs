...
var n = Object.defineProperty, M = Object.getOwnPropertyDescriptor, h = (e, V, i, o) => {
  for (var t = o > 1 ? void 0 : o ? M(V, i) : V, p = e.length - 1, v; p >= 0; p--)
    (v = e[p]) && (t = (o ? v(V, i, t) : v(t)) || t);
  return o && t && n(V, i, t), t;
};
