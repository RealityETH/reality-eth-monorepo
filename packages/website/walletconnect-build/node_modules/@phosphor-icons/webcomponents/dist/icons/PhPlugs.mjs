...
var u = Object.defineProperty, c = Object.getOwnPropertyDescriptor, e = (r, L, p, s) => {
  for (var l = s > 1 ? void 0 : s ? c(L, p) : L, i = r.length - 1, m; i >= 0; i--)
    (m = r[i]) && (l = (s ? m(L, p, l) : m(l)) || l);
  return s && l && u(L, p, l), l;
};
