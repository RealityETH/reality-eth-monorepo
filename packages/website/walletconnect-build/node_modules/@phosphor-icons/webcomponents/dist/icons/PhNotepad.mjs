...
var n = Object.defineProperty, g = Object.getOwnPropertyDescriptor, V = (r, h, s, H) => {
  for (var t = H > 1 ? void 0 : H ? g(h, s) : h, p = r.length - 1, i; p >= 0; p--)
    (i = r[p]) && (t = (H ? i(h, s, t) : i(t)) || t);
