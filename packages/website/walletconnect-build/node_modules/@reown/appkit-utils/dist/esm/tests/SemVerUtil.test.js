...
describe('SemVerUtils', () => {
    describe('extractVersion', () => {
        ...
        it('should handle edge cases', () => {
            ...
            expect(SemVerUtils.extractVersion(null)).toBe(null);
        });
    ...
    describe('isOlder', () => {
        describe('basic version comparisons', () => {
            it('should return true when current version is older than latest (major version)', () => {
                expect(SemVerUtils.isOlder('1.7.1', '2.0.0')).toBe(true);
                expect(SemVerUtils.isOlder('1.7.1', '1.8.0')).toBe(true);
            });
            it('should return false when current version is newer than latest (major version)', () => {
                expect(SemVerUtils.isOlder('2.0.0', '1.7.1')).toBe(false);
                expect(SemVerUtils.isOlder('1.8.0', '1.7.1')).toBe(false);
            });
            it('should return true when current version is older than latest (minor version)', () => {
                expect(SemVerUtils.isOlder('1.7.1', '1.8.0')).toBe(true);
                expect(SemVerUtils.isOlder('1.7.9', '1.8.0')).toBe(true);
            });
            it('should return true when current version is older than latest (patch version)', () => {
                expect(SemVerUtils.isOlder('1.7.1', '1.7.2')).toBe(true);
                expect(SemVerUtils.isOlder('1.7.8', '1.7.9')).toBe(true);
            });
            it('should return false when versions are equal', () => {
                expect(SemVerUtils.isOlder('1.7.1', '1.7.1')).toBe(false);
                expect(SemVerUtils.isOlder('2.0.0', '2.0.0')).toBe(false);
                expect(SemVerUtils.isOlder('1.8.3', '1.8.3')).toBe(false);
            });
        });
        describe('canary version comparisons', () => {
            it('should handle canary versions correctly - current canary vs stable latest', () => {
                expect(SemVerUtils.isOlder('1.7.1-canary.3', '1.8.3')).toBe(true);
                expect(SemVerUtils.isOlder('1.7.1-canary.3', '1.8.0')).toBe(true);
                expect(SemVerUtils.isOlder('1.6.9-canary.1', '1.7.0')).toBe(true);
            });
            it('should handle complex canary version strings', () => {
                expect(SemVerUtils.isOlder('1.7.1-abcdef123.456', '1.8.3')).toBe(true);
                expect(SemVerUtils.isOlder('1.8.3-xyz789.123', '1.7.1')).toBe(false);
                expect(SemVerUtils.isOlder('1.7.1-abcdef123.456', '1.7.1')).toBe(false);
            });
            it('should handle full SDK version format strings', () => {
                expect(SemVerUtils.isOlder('html-react-1.7.1-canary.3', '1.8.3')).toBe(true);
                expect(SemVerUtils.isOlder('html-wagmi-1.8.3', '1.7.1')).toBe(false);
                expect(SemVerUtils.isOlder('vue-ethers-1.7.1', '1.7.1')).toBe(false);
            });
        });
        describe('edge cases', () => {
            it('should handle versions with missing parts (treated as 0)', () => {
                expect(SemVerUtils.isOlder('1.7', '1.7.1')).toBe(true);
                expect(SemVerUtils.isOlder('1.7.1', '1.7')).toBe(false);
                expect(SemVerUtils.isOlder('1', '1.0.1')).toBe(true);
            });
            it('should handle invalid version strings gracefully', () => {
                expect(SemVerUtils.isOlder('', '1.7.1')).toBe(false);
                expect(SemVerUtils.isOlder('1.7.1', '')).toBe(false);
                expect(SemVerUtils.isOlder('1.7.1', 'invalid')).toBe(false);
            });
            it('should handle versions with extra parts', () => {
                expect(SemVerUtils.isOlder('1.7.1.0', '1.7.2')).toBe(true);
                expect(SemVerUtils.isOlder('1.7.2', '1.7.1.0')).toBe(false);
            });
        });
    });
    describe('checkSDKVersion', () => {
        ...
        it('should not check version in production', () => {
            ...
            SemVerUtils.checkSDKVersion('html-wagmi-1.7.1-canary.3');
        ...
        it('should not check version when packageVersion is not available', () => {
            ...
            SemVerUtils.checkSDKVersion('html-react-invalid'); // No valid version
            expect(fetchSpy).not.toHaveBeenCalled();
            expect(consoleLogSpy).not.toHaveBeenCalled();
            expect(consoleWarnSpy).not.toHaveBeenCalled();
            coreHelperMock.mockRestore();
...
//# sourceMappingURL=SemVerUtil.test.js.map