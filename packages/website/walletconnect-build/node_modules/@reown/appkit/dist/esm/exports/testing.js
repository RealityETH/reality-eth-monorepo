...
export const solanaTestnetCaipNetwork = CaipNetworksUtil.extendCaipNetwork(solanaTestnet, extendProps);
export const bitcoinCaipNetwork = CaipNetworksUtil.extendCaipNetwork(bitcoin, extendProps);
export const bitcoinTestnetCaipNetwork = CaipNetworksUtil.extendCaipNetwork(bitcoinTestnet, extendProps);
