...
import { ChainController, ConnectionController, ConnectorController, OptionsController, RouterController, SnackController } from '@reown/appkit-controllers';
    ...
    describe('Disconnect Logic', () => {
        ...
        beforeEach(async () => {
            ...
            vi.spyOn(ConnectorController, 'state', 'get').mockReturnValue({
                ...
                activeConnectorIds: { [TEST_CHAIN]: TEST_CONNECTOR_ID }
            });
...
//# sourceMappingURL=w3m-unsupported-chain-view.test.js.map