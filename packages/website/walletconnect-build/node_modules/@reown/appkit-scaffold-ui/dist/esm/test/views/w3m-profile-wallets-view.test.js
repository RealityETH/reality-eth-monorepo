...
import { ChainController, ConnectionController, ConnectionControllerUtil, ConnectorController, CoreHelperUtil, ModalController, OptionsController, RouterController, SnackController, StorageUtil } from '@reown/appkit-controllers';
...
describe('W3mProfileWalletsView - onConnectionsChange', () => {
    ...
    beforeEach(async () => {
        ...
        element = await fixture(html `<w3m-profile-wallets-view></w3m-profile-wallets-view>`);
