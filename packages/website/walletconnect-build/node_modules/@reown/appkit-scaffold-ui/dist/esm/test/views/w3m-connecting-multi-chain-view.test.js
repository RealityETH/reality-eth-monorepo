...
describe('W3mConnectingMultiChainView', () => {
    ...
    it('should push to ConnectingExternal with wallet parameter', async () => {
        ...
        const element = await fixture(html `<w3m-connecting-multi-chain-view></w3m-connecting-multi-chain-view>`);
...
//# sourceMappingURL=w3m-connecting-multi-chain-view.test.js.map