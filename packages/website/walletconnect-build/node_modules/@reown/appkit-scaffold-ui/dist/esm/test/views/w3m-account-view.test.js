...
describe('W3mAccountView', () => {
    ...
    it('should render', async () => {
        const element = await fixture(html `<w3m-account-view></w3m-account-view>`);
    ...
    it('should render default account widget when no auth connector exists', async () => {
        vi.spyOn(ConnectorController, 'getConnectorId').mockReturnValue(CommonConstantsUtil.CONNECTOR_ID.WALLET_CONNECT);
        vi.spyOn(ConnectorController, 'getAuthConnector').mockReturnValue(undefined);
        const element = await fixture(html `<w3m-account-view></w3m-account-view>`);
...
//# sourceMappingURL=w3m-account-view.test.js.map