...
describe('W3mSwapView', () => {
    ...
    it('should handle token switching', async () => {
        ...
        const switchButton = element.shadowRoot?.querySelector('wui-flex.replace-tokens-button-container wui-icon-box');
        switchButton?.click();
    ...
    it('should handle caipAddress change', async () => {
        ...
        const accountStateCallback = subscribeChainPropSpy.mock.calls.find(call => call[0] === 'accountState')?.[1];
