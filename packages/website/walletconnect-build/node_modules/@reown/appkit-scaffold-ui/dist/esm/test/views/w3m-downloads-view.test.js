...
describe('W3mDownloadsView', () => {
    ...
    it('should render the component with basic structure', async () => {
        ...
        const element = await fixture(html `<w3m-downloads-view></w3m-downloads-view>`);
    ...
    it('should not render Chrome Extension when chrome_store is null', async () => {
        ...
        const element = await fixture(html `<w3m-downloads-view></w3m-downloads-view>`);
        const chromeButton = Array.from(HelpersUtil.querySelectAll(element, CHROME_STORE_BUTTON)).find(button => HelpersUtil.getTextContent(button).includes('Chrome Extension'));
    ...
    it('should not render App Store when app_store is null', async () => {
        ...
        const element = await fixture(html `<w3m-downloads-view></w3m-downloads-view>`);
        const appStoreButton = Array.from(HelpersUtil.querySelectAll(element, APP_STORE_BUTTON)).find(button => HelpersUtil.getTextContent(button).includes('iOS App'));
    ...
    it('should not render Play Store when play_store is null', async () => {
        ...
        const element = await fixture(html `<w3m-downloads-view></w3m-downloads-view>`);
        const playStoreButton = Array.from(HelpersUtil.querySelectAll(element, PLAY_STORE_BUTTON)).find(button => HelpersUtil.getTextContent(button).includes('Android App'));
    ...
    it('should not render Homepage when homepage is undefined', async () => {
        ...
        const element = await fixture(html `<w3m-downloads-view></w3m-downloads-view>`);
        const homepageButton = Array.from(HelpersUtil.querySelectAll(element, HOMEPAGE_BUTTON)).find(button => HelpersUtil.getTextContent(button).includes('Website'));
    ...
    it('should not call openHref or sendEvent when wallet is undefined', async () => {
        ...
        await expect(fixture(html `<w3m-downloads-view></w3m-downloads-view>`)).rejects.toThrow('w3m-downloads-view');
        expect(sendEventSpy).not.toHaveBeenCalled();
        expect(openHrefSpy).not.toHaveBeenCalled();
    });
...
//# sourceMappingURL=w3m-downloads-view.test.js.map