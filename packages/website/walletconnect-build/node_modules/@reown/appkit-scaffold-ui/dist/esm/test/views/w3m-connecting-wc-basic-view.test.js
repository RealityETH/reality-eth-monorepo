...
import { ApiController, ConnectionController, ConnectorController, CoreHelperUtil, OptionsController, StorageUtil } from '@reown/appkit-controllers';
...
describe('W3mConnectingWcBasicView', () => {
    ...
    it('should render', async () => {
        const element = await fixture(html `<w3m-connecting-wc-basic-view></w3m-connecting-wc-basic-view>`);
    ...
    it('should unsubscribe on disconnect', async () => {
        ...
        vi.spyOn(OptionsController, 'subscribeKey').mockImplementation(vi.fn().mockReturnValue(mockUnsubscribe));
        const element = await fixture(html `<w3m-connecting-wc-basic-view></w3m-connecting-wc-basic-view>`);
        element.disconnectedCallback();
        expect(mockUnsubscribe).toHaveBeenCalled();
    });
});
//# sourceMappingURL=w3m-connecting-wc-basic-view.test.js.map