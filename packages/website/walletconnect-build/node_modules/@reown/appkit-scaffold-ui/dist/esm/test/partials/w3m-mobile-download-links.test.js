...
describe('W3mMobileDownloadLinks', () => {
    ...
    it('should hide when no wallet provided', async () => {
        const el = (await fixture(html `<w3m-mobile-download-links></w3m-mobile-download-links>`));
        expect(el.style.display).toBe('none');
    });
    it('should show single homepage button and opens homepage', async () => {
        const el = await fixture(html `<w3m-mobile-download-links
...
//# sourceMappingURL=w3m-mobile-download-links.test.js.map