...
import { ChainController, CoreHelperUtil, EventsController, RouterController } from '@reown/appkit-controllers';
...
describe('W3mChooseAccountNameView', () => {
    ...
    it('should render', async () => {
        const element = await fixture(html `<w3m-choose-account-name-view></w3m-choose-account-name-view>`);
    ...
    it('should render onboarding content', async () => {
        ...
        const titleText = Array.from(textElements || []).find(el => el.textContent?.includes('Choose your account name'));
        const descriptionText = Array.from(textElements || []).find(el => el.textContent?.includes('Finally say goodbye to 0x addresses'));
...
//# sourceMappingURL=w3m-choose-account-name-view.test.js.map