...
const MOCK_PAYMENT_CURRENCIES = [
    { id: 'USD', payment_method_limits: [] },
    { id: 'EUR', payment_method_limits: [] }
];
const MOCK_PURCHASE_CURRENCIES = [
...
describe('W3mInputCurrency', () => {
    let subscribeKeyMock;
    let subscribeKeyCallbacks = {};
    beforeEach(() => {
        subscribeKeyCallbacks = {};
        subscribeKeyMock = vi.fn().mockImplementation((key, callback) => {
    ...
    it('should render with default properties', async () => {
        const element = await fixture(html `<w3m-onramp-input></w3m-onramp-input>`);
    ...
    it('should render fiat currency selector', async () => {
        const element = await fixture(html `<w3m-onramp-input type="Fiat"></w3m-onramp-input>`);
    ...
    it('should render token currency selector', async () => {
        const element = await fixture(html `<w3m-onramp-input type="Token"></w3m-onramp-input>`);
...
//# sourceMappingURL=w3m-onramp-input.test.js.map