...
describe('W3mFundWalletView', () => {
    ...
    it('should render the component with basic structure', async () => {
        ...
        const element = await fixture(html `<w3m-fund-wallet-view></w3m-fund-wallet-view>`);
    ...
    it('should show buy crypto option when onramp is available', async () => {
        ...
        const element = await fixture(html `<w3m-fund-wallet-view></w3m-fund-wallet-view>`);
        await elementUpdated(element);
        const buyCryptoButton = HelpersUtil.querySelect(element, '[data-testid="wallet-features-onramp-button"]');
    ...
    it('should show receive funds option when receive feature is enabled', async () => {
        ...
        const element = await fixture(html `<w3m-fund-wallet-view></w3m-fund-wallet-view>`);
        await elementUpdated(element);
        const receiveFundsButton = HelpersUtil.querySelect(element, '[data-testid="wallet-features-receive-button"]');
    ...
    it('should not show deposit from exchange option when payWithExchange is disabled', async () => {
        ...
        const element = await fixture(html `<w3m-fund-wallet-view></w3m-fund-wallet-view>`);
        await elementUpdated(element);
        const depositFromExchangeButton = HelpersUtil.getByTestId(element, DEPOSIT_FROM_EXCHANGE_BUTTON_TEST_ID);
...
//# sourceMappingURL=w3m-fund-wallet-view.test.js.map