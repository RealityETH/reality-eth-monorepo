...
describe('W3mConnectWalletsView', () => {
    beforeEach(() => {
        ...
        vi.spyOn(OptionsStateController, 'subscribeKey').mockImplementation(vi.fn().mockReturnValue(vi.fn()));
    });
    it('should render', async () => {
        const element = await fixture(html `<w3m-connect-wallets-view></w3m-connect-wallets-view>`);
    ...
    it('should unsubscribe on disconnect', async () => {
        ...
        vi.spyOn(OptionsStateController, 'subscribeKey').mockImplementation(vi.fn().mockReturnValue(unsubscribeMock));
        const element = await fixture(html `<w3m-connect-wallets-view></w3m-connect-wallets-view>`);
        element.disconnectedCallback();
        expect(unsubscribeMock).toHaveBeenCalled();
    });
});
//# sourceMappingURL=w3m-connect-wallets-view.test.js.map