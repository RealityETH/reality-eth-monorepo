...
describe('W3mConnectingWcUnsupported', () => {
    ...
    it('should render wallet image, text, and download links', async () => {
        const element = await fixture(html `<w3m-connecting-wc-unsupported></w3m-connecting-wc-unsupported>`);
        ...
        const downloadLinks = HelpersUtil.querySelect(element, 'w3m-mobile-download-links');
    ...
    it('should track SELECT_WALLET with proper properties on construct', async () => {
        ;
        (await fixture(html `<w3m-connecting-wc-unsupported></w3m-connecting-wc-unsupported>`));
    ...
    it('should throw if no wallet provided via RouterController.state', async () => {
        ...
        const { W3mConnectingWcUnsupported } = await import('../../src/partials/w3m-connecting-wc-unsupported/index');
        expect(() => new W3mConnectingWcUnsupported()).toThrow('w3m-connecting-wc-unsupported: No wallet provided');
    });
});
//# sourceMappingURL=w3m-connecting-wc-unsupported.test.js.map