...
import { ChainController, ConnectorController, CoreHelperUtil, EventsController, OptionsController } from '@reown/appkit-controllers';
...
describe('W3mSocialLoginWidget', () => {
    ...
    it('should handle standard social login flow when clicking Google button', async () => {
        ...
        expect(ChainController.setAccountProp).toHaveBeenCalledWith('socialProvider', 'google', 'eip155');
        expect(ChainController.setAccountProp).toHaveBeenCalledWith('socialWindow', mockWindow, 'eip155');
