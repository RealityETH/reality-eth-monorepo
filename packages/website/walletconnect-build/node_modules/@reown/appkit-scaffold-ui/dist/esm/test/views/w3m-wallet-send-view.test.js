...
import { ChainController, ConnectionController, RouterController, SendController, SwapController } from '@reown/appkit-controllers';
...
describe('W3mWalletSendView', () => {
    ...
    it('should show insufficient funds message when amount exceeds balance', async () => {
        ...
        await element.updateComplete;
        await element.render();
        const [fundWalletButton, connectDifferentWalletButton] = element.shadowRoot?.querySelectorAll('wui-button') ?? [];
