...
import { matchNonWildcardPattern, matchWildcardPattern, parseOriginRaw, parseSchemelessHostPort, parseUrl } from '../../src/utils/UrlUtils.js';
describe('UrlUtils', () => {
    ...
    describe('pattern matchers', () => {
        ...
        test('matchWildcardPattern respects scheme and port and label counts', () => {
            ...
            expect(matchWildcardPattern(new URL('https://example.com'), 'https://example.com', 'https://*.example.com')).toBe(false);
        });
