...
import { BlockchainApiController, ChainController, ConnectionController, ConnectorController, RouterController, SwapController } from '../../exports/index.js';
...
describe('SwapController', () => {
    ...
    it('should handle large token amounts with 18 decimal token', async () => {
        ...
        await SwapController.swapTokens();
        await vi.waitFor(() => expect(fetchSwapQuoteSpy).toHaveBeenCalledWith(expect.objectContaining({
    ...
    it('should show chain-specific suggested token first when active network is Arbitrum', async () => {
        ...
        const mockTokens = [
            {
                address: 'eip155:42161:0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee',
                symbol: 'ETH',
                name: 'Ether',
                decimals: 18,
                logoUri: ''
            ...
            {
                address: 'eip155:42161:0x0000000000000000000000000000000000000000',
                symbol: 'USD₮0',
                name: 'Tether USD0',
                decimals: 6,
                logoUri: ''
