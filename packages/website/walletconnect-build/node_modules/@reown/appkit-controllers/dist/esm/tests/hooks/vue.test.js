...
import { ChainController, ConnectionController, ConnectorController, OptionsController, StorageUtil } from '../../exports/index.js';
...
import { connectedAccountState, connectedWithEmbeddedWalletState, defaultAccountState } from '../mocks/useAppKitAccount.js';
...
describe('useAppKitConnections', () => {
    ...
    it('should use provided namespace instead of active chain', async () => {
        ...
        await nextTick();
        expect(ConnectionControllerUtil.getConnectionsData).toHaveBeenCalledWith(ConstantsUtil.CHAIN.SOLANA);
    });
