...
import { ChainController, ConnectorController, EventsController, ModalController, StorageUtil } from '../../exports/index.js';
...
describe('updateEmail', () => {
    it('should open "UpdateEmailWallet" view', async () => {
        ...
        vi.spyOn(StorageUtil, 'getConnectedConnectorId').mockReturnValue(CommonConstantsUtil.CONNECTOR_ID.AUTH);
