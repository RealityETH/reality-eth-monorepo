...
describe('AlertController', () => {
    ...
    describe('console logging', () => {
        ...
        it('should use console.error for error variant in development', () => {
            ...
            expect(consoleErrorSpy).toHaveBeenCalledWith('Embedded wallet load failed. Ensure your domain is verified in https://dashboard.reown.com.', { code: 'APKT005' });
        });
