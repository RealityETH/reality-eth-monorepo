...
describe('UiHelperUtil', () => {
    ...
    describe('getHostName', () => {
        it('extracts hostname from valid URL', () => {
            expect(UiHelperUtil.getHostName('https://www.example.com/path?query=1')).toBe('www.example.com');
        });
    ...
    describe('getTruncateString', () => {
        ...
        it('does not truncate if string is short', () => {
            expect(UiHelperUtil.getTruncateString({
                string: 'short',
                charsStart: 10,
                charsEnd: 10,
                truncate: 'middle'
    ...
    describe('tintColor', () => {
        it('tints RGB color', () => {
            ...
            expect(UiHelperUtil.tintColor([100, 150, 200], 0.5)).toEqual([178, 203, 228]);
        });
    });
    describe('isNumber', () => {
        it('checks if string is numeric', () => {
            ...
            expect(UiHelperUtil.isNumber('1.2')).toBe(false);
        });
    });
    describe('getColorTheme', () => {
        ...
        it('returns dark if undefined and no window match', () => {
            expect(UiHelperUtil.getColorTheme(undefined)).toBe('dark');
        });
    });
    describe('splitBalance', () => {
        ...
        it('returns [0,00] if no dot or multiple dots', () => {
            ...
            expect(UiHelperUtil.splitBalance('123.456.789')).toEqual(['0', '00']);
        });
    ...
    describe('roundNumber', () => {
        it('rounds to fixed if toString length >= threshold', () => {
            expect(UiHelperUtil.roundNumber(1234567, 7, 2)).toBe('1234567.00');
            expect(UiHelperUtil.roundNumber(123456, 7, 2)).toBe(123456);
        });
        it('handles decimals', () => {
    ...
    describe('maskInput', () => {
        ...
        it('handles decimals when decimals is 0 or not a number', () => {
            ...
            expect(UiHelperUtil.maskInput({ value: '12.34', decimals: undefined, integers: 10 })).toBe('12.34');
        });
        ...
        it('large inputs respect both integer and decimal caps', () => {
            expect(UiHelperUtil.maskInput({ value: '9876543210.1234567890', decimals: 4, integers: 6 })).toBe('987654.1234');
        });
    });
