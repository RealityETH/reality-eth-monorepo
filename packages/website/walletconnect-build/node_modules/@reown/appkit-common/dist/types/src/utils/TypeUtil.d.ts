...
export type InternalChainNamespace = 'eip155' | 'solana' | 'polkadot' | 'bip122' | 'cosmos' | 'sui' | 'stacks' | 'ton';
export type ChainNamespace<T extends string = InternalChainNamespace> = T | InternalChainNamespace;
export type AdapterType = 'solana' | 'wagmi' | 'ethers' | 'ethers5' | 'universal' | 'bip122' | 'polkadot' | 'ton';
