...
describe('ErrorUtil', () => {
    ...
    describe('isUserRejectedRequestError', () => {
        ...
        it('returns true for Error instance with user rejection phrasing in message', () => {
            expect(ErrorUtil.isUserRejectedRequestError(new Error('User rejected the operation'))).toBe(true);
            expect(ErrorUtil.isUserRejectedRequestError(new Error('User cancelled the operation'))).toBe(true);
        });
    });
