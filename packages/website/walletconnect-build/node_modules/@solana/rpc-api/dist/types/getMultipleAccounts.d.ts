...
export type GetMultipleAccountsApi = {
     ...
     */
    getMultipleAccounts(addresses: readonly Address[], config: GetMultipleAccountsApiCommonConfig & GetMultipleAccountsApiSliceableCommonConfig & Readonly<{
        encoding: 'base64';
     ...
     * @see https://solana.com/docs/rpc/http/getmultipleaccounts
     */
    getMultipleAccounts(addresses: readonly Address[], config: GetMultipleAccountsApiCommonConfig & Readonly<{
        encoding: 'jsonParsed';
     ...
     * @see https://solana.com/docs/rpc/http/getmultipleaccounts
     */
    getMultipleAccounts(addresses: readonly Address[], config?: GetMultipleAccountsApiCommonConfig): SolanaRpcResponse<(GetMultipleAccountsApiResponseBase & (AccountInfoWithBase64EncodedData | null))[]>;
};
export {};
