...
export type GetAccountInfoApi = {
     ...
     * @see https://solana.com/docs/rpc/http/getaccountinfo
     */
    getAccountInfo(address: Address, config?: Omit<GetAccountInfoApiCommonConfig, 'encoding'>): GetAccountInfoApiResponseBase & NestInRpcResponseOrNull<AccountInfoWithBase58Bytes>;
};
export {};
