    ...
    return (client) => {
        return {
            accessKey: {
                ...
                burnWitness: (parameters) => accessKeyActions.burnWitness(client, parameters),
                burnWitnessSync: (parameters) => accessKeyActions.burnWitnessSync(client, parameters),
                ...
                isWitnessBurned: (parameters) => accessKeyActions.isWitnessBurned(client, parameters),
                ...
                watchAdminAuthorized: (parameters) => accessKeyActions.watchAdminAuthorized(client, parameters),
                watchWitness: (parameters) => accessKeyActions.watchWitness(client, parameters),
                watchWitnessBurned: (parameters) => accessKeyActions.watchWitnessBurned(client, parameters),
            },
            amm: {
            ...
            receivePolicy: {
                ...
                burnSync: (parameters) => receivePolicyActions.burnSync(client, parameters),
                claim: (parameters) => receivePolicyActions.claim(client, parameters),
                claimSync: (parameters) => receivePolicyActions.claimSync(client, parameters),
                get: (parameters) => receivePolicyActions.get(client, parameters),
                getBlockedBalance: (parameters) => receivePolicyActions.getBlockedBalance(client, parameters),
                set: (parameters) => receivePolicyActions.set(client, parameters),
                setSync: (parameters) => receivePolicyActions.setSync(client, parameters),
                validate: (parameters) => receivePolicyActions.validate(client, parameters),
                watchBlocked: (parameters) => receivePolicyActions.watchBlocked(client, parameters),
                watchBurned: (parameters) => receivePolicyActions.watchBurned(client, parameters),
                watchClaimed: (parameters) => receivePolicyActions.watchClaimed(client, parameters),
                watchUpdated: (parameters) => receivePolicyActions.watchUpdated(client, parameters),
            },
            reward: {
