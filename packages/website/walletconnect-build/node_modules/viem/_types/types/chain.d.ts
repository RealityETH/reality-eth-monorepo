...
export type Chain<formatters extends ChainFormatters | undefined = ChainFormatters | undefined, extendSchema extends Record<string, unknown> | undefined = Record<string, unknown> | undefined> = {
...
type ChainVerifyHashFn = (client: Client, parameters: VerifyHashParameters) => Promise<VerifyHashReturnType>;
export type ChainConfig<formatters extends ChainFormatters | undefined = ChainFormatters | undefined, extendSchema extends Record<string, unknown> | undefined = Record<string, unknown> | undefined> = {
