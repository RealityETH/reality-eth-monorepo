...
rc_common.checkArgumentLength(4, 'Usage: node allocate_splitter_funds.js <nonce> <gas_price_in_gwei>');
...
const req = wal.allocate.request();
const data = req.params[0].data;

const stx = rc_common.serializedTX(params, wal, data, 600000, true);
