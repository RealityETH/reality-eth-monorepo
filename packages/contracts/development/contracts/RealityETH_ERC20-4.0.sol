...
contract RealityETH_ERC20_v4_0 is BalanceHolder_ERC20 {
    ...
    event LogNewAnswer(
        ...
        uint256 bond,
        uint256 ts,
        bool is_commitment // Now always false, preserved for API compatibility
    );
    ...
    function _addAnswerToHistory(bytes32 question_id, bytes32 answer, address answerer, uint256 bond) 
    internal 
    {
