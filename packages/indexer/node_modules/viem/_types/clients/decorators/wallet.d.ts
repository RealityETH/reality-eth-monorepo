...
export type WalletActions<chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined, tokens extends Tokens | undefined = Tokens | undefined> = {
    /**
     ...
     * })
     */
    sendTransactionSync: <const request extends SendTransactionSyncRequest<chain, chainOverride>, chainOverride extends Chain | undefined = undefined>(args: SendTransactionSyncParameters<chain, account, chainOverride, request>) => Promise<SendTransactionSyncReturnType<chain>>;
    /**
    ...
    token: {
         ...
         * })
         */
        approveSync: (parameters: approveSync.Parameters<chain, account, tokens>) => Promise<approveSync.ReturnValue>;
        /**
         * Approves a `spender` to transfer up to `amount` tokens on behalf of the
         ...
         * })
         */
        approve: ((parameters: approve.Parameters<chain, account, tokens>) => Promise<approve.ReturnValue>) & {
            /**
             ...
             */
            call: (args: approve.Args<chain, tokens>) => ReturnType<typeof approve.call>;
            /**
             ...
             */
            estimateGas: (parameters: approve.Parameters<chain, account, tokens>) => Promise<bigint>;
            /**
             ...
             */
            simulate: (parameters: approve.Parameters<chain, account, tokens>) => ReturnType<typeof approve.simulate>;
        };
        /**
         ...
         * })
         */
        transferSync: (parameters: transferSync.Parameters<chain, account, tokens>) => Promise<transferSync.ReturnValue>;
        /**
         ...
         * })
         */
        transfer: ((parameters: transfer.Parameters<chain, account, tokens>) => Promise<transfer.ReturnValue>) & {
            /**
             ...
             * @returns The contract call.
             */
            call: (args: transfer.Args<chain, tokens>) => ReturnType<typeof transfer.call>;
            /**
             ...
             * @returns The gas estimate.
             */
            estimateGas: (parameters: transfer.Parameters<chain, account, tokens>) => Promise<bigint>;
            /**
             ...
             * @returns The simulation result and write request.
             */
            simulate: (parameters: transfer.Parameters<chain, account, tokens>) => ReturnType<typeof transfer.simulate>;
        };
    };
};
export declare function walletActions<transport extends Transport, chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined, tokens extends Tokens | undefined = Tokens | undefined>(client: Client<transport, chain, account, undefined, undefined, tokens>): WalletActions<chain, account, tokens>;
