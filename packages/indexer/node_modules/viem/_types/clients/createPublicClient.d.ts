...
export type PublicClientConfig<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, accountOrAddress extends Account | Address | undefined = undefined, rpcSchema extends RpcSchema | undefined = undefined, tokens extends Tokens | undefined = Tokens | undefined> = Prettify<Pick<ClientConfig<transport, chain, accountOrAddress, rpcSchema, tokens>, 'batch' | 'cacheTime' | 'ccipRead' | 'chain' | 'experimental_blockTag' | 'key' | 'name' | 'pollingInterval' | 'rpcSchema' | 'tokens' | 'transport'>>;
export type PublicClient<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, accountOrAddress extends Account | undefined = undefined, rpcSchema extends RpcSchema | undefined = undefined, tokens extends Tokens | undefined = Tokens | undefined> = Prettify<Client<transport, chain, accountOrAddress, rpcSchema extends RpcSchema ? [...PublicRpcSchema, ...rpcSchema] : PublicRpcSchema, PublicActions<transport, chain, accountOrAddress, tokens>, tokens>>;
 ...
 * })
 */
export declare function createPublicClient<transport extends Transport, chain extends Chain | undefined = undefined, accountOrAddress extends Account | Address | undefined = undefined, rpcSchema extends RpcSchema | undefined = undefined, const tokens extends Tokens | undefined = undefined>(parameters: PublicClientConfig<transport, chain, accountOrAddress, rpcSchema, tokens>): PublicClient<transport, chain, ParseAccount<accountOrAddress>, rpcSchema, tokens>;
