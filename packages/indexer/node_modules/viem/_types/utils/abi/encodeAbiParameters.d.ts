 ...
 * ```
 */
export declare function encodeAbiParameters<const params extends readonly AbiParameter[] | readonly unknown[]>(params: params, values: params extends readonly AbiParameter[] ? AbiParametersToPrimitiveTypes<params, AbiParameterKind, true> : never): EncodeAbiParametersReturnType;
