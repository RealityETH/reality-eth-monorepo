...
export type EncodeEventTopicsReturnType<abi extends Abi | readonly unknown[] = Abi, eventName extends ContractEventName<abi> | undefined = undefined, resolvedEvent = abi extends Abi ? eventName extends string ? Extract<ExtractAbiEvents<abi>, {
    name: eventName;
}> : abi['length'] extends 1 ? abi[0] : ExtractAbiEvents<abi> : unknown> = IsNarrowable<abi, Abi> extends true ? [resolvedEvent] extends [{
    anonymous: true;
}] ? (Hex | Hex[] | null)[] : [Hex, ...(Hex | Hex[] | null)[]] : (Hex | Hex[] | null)[];
...
export declare function encodeEventTopics<const abi extends Abi | readonly unknown[], eventName extends ContractEventName<abi> | undefined = undefined>(parameters: EncodeEventTopicsParameters<abi, eventName>): EncodeEventTopicsReturnType<abi, eventName>;
