...
import { type InvalidLegacyVErrorType, type InvalidSerializedTransactionErrorType, type InvalidYParityErrorType } from '../../errors/transaction.js';
...
type ParseEIP155SignatureErrorType = HexToBigIntErrorType | InvalidYParityErrorType | PadHexErrorType | ErrorType;
export {};
