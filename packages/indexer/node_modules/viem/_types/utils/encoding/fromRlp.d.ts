...
import { type InvalidHexValueErrorType, type RlpDepthLimitExceededErrorType, type RlpListBoundaryExceededErrorType, type RlpTrailingBytesErrorType } from '../../errors/encoding.js';
...
export type FromRlpErrorType = CreateCursorErrorType | FromRlpCursorErrorType | HexToBytesErrorType | InvalidHexValueErrorType | RlpDepthLimitExceededErrorType | RlpTrailingBytesErrorType | ErrorType;
