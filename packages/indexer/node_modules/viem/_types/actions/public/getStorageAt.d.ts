...
export type GetStorageAtErrorType = FormatBlockParameterErrorType | RequestErrorType | ErrorType;
/**
 ...
 * })
 */
export declare function getStorageAt<chain extends Chain | undefined>(client: Client<Transport, chain>, { address, blockHash, blockNumber, blockTag, requireCanonical, slot, }: GetStorageAtParameters): Promise<GetStorageAtReturnType>;
