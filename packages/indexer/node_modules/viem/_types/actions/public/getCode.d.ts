...
export type GetCodeErrorType = FormatBlockParameterErrorType | RequestErrorType | ErrorType;
/**
 ...
 * })
 */
export declare function getCode<chain extends Chain | undefined>(client: Client<Transport, chain>, { address, blockHash, blockNumber, blockTag, requireCanonical, }: GetCodeParameters): Promise<GetCodeReturnType>;
