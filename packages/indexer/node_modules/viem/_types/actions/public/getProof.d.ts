...
export type GetProofErrorType = FormatBlockParameterErrorType | FormatProofErrorType | RequestErrorType | ErrorType;
/**
 ...
 * })
 */
export declare function getProof<chain extends Chain | undefined>(client: Client<Transport, chain>, { address, blockHash, blockNumber, blockTag, requireCanonical, storageKeys, }: GetProofParameters): Promise<GetProofReturnType>;
