...
export type GetTransactionCountErrorType = RequestErrorType | FormatBlockParameterErrorType | HexToNumberErrorType | ErrorType;
/**
 ...
 * })
 */
export declare function getTransactionCount<chain extends Chain | undefined, account extends Account | undefined>(client: Client<Transport, chain, account>, { address, blockHash, blockNumber, blockTag, requireCanonical, }: GetTransactionCountParameters): Promise<GetTransactionCountReturnType>;
