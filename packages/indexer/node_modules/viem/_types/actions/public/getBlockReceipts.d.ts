...
export type GetBlockReceiptsReturnType<chain extends Chain | undefined = undefined> = FormattedTransactionReceipt<chain>[];
export type GetBlockReceiptsErrorType = BlockNotFoundErrorType | NumberToHexErrorType | RequestErrorType | ErrorType;
/**
 ...
 * })
 */
export declare function getBlockReceipts<chain extends Chain | undefined>(client: Client<Transport, chain>, { blockHash, blockNumber, blockTag, }?: GetBlockReceiptsParameters): Promise<GetBlockReceiptsReturnType<chain>>;
//# sourceMappingURL=getBlockReceipts.d.ts.map