...
export type ReadContractParameters<abi extends Abi | readonly unknown[] = Abi, functionName extends ContractFunctionName<abi, 'pure' | 'view'> = ContractFunctionName<abi, 'pure' | 'view'>, args extends ContractFunctionArgs<abi, 'pure' | 'view', functionName> = ContractFunctionArgs<abi, 'pure' | 'view', functionName>> = UnionEvaluate<Pick<CallParameters, 'account' | 'authorizationList' | 'blockHash' | 'blockNumber' | 'blockOverrides' | 'blockTag' | 'factory' | 'factoryData' | 'requireCanonical' | 'stateOverride'>> & ContractFunctionParameters<abi, 'pure' | 'view', functionName, args, boolean>;
