...
import { type Client as Client_, type ClientConfig as ClientConfig_ } from '../clients/createClient.js';
 ...
 */
export type ClientConfig<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, accountOrAddress extends Account | Address | undefined = Account | Address | undefined, rpcSchema extends RpcSchema | undefined = undefined> = Prettify<Omit<ClientConfig_<transport, chain, accountOrAddress, rpcSchema>, 'chain' | 'transport'> & {
    /**
 ...
 */
export type Client<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined, rpcSchema extends RpcSchema | undefined = undefined> = Prettify<Client_<transport, chain, account, rpcSchema, Omit<PublicActions<transport, chain, account> & WalletActions<chain, account>, 'token'> & Decorator<chain, account>>>;
 ...
 */
export declare function createClient<transport extends Transport = Transport, chain extends Chain | undefined = typeof tempo, accountOrAddress extends Account | Address | undefined = undefined, rpcSchema extends RpcSchema | undefined = undefined>(parameters?: ClientConfig<transport, chain, accountOrAddress, rpcSchema>): Client<transport, chain, accountOrAddress extends Address ? Prettify<JsonRpcAccount<accountOrAddress>> : accountOrAddress, rpcSchema>;
