...
const getL2BlockNumberAtTimestamp_js_1 = require("../utils/getL2BlockNumberAtTimestamp.js");
...
async function buildProveWithdrawal(client, args) {
    ...
    const blockNumber = game?.usesSuperRoots
        ? await (0, getL2BlockNumberAtTimestamp_js_1.getL2BlockNumberAtTimestamp)(client, {
