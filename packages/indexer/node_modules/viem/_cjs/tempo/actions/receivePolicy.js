...
function resolveClaimer(claimer, self) {
    const recoveryAuthority = claimer === 'sender' ? address_js_1.zeroAddress : claimer === 'self' ? self : claimer;
...
function assertValidRecoveryAuthority(recoveryAuthority) {
    if ((0, index_js_1.isAddressEqual)(recoveryAuthority, address_js_1.zeroAddress))
        return;
    if (tempo_1.VirtualAddress.isVirtual(recoveryAuthority))
    ...
    if (systemPrecompiles.some((address) => (0, index_js_1.isAddressEqual)(address, recoveryAuthority)))
