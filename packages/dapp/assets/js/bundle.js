...
(function () {
    ...
    (function () {
        ...
        for (var i = 0, len = arbitrationButtons.length; i < len; i += 1) {
    ...
    (function () {
        var rcbrowsers = document.querySelectorAll('.rcbrowser-inner');

        for (var i = 0, len = rcbrowsers.length; i < len; i += 1) {
            _perfectScrollbar2.default.initialize(rcbrowsers[i]);
        }

        function changeSize() {
            for (var _i24 = 0, _len24 = rcbrowsers.length; _i24 < _len24; _i24 += 1) {
                _perfectScrollbar2.default.update(rcbrowsers[_i24]);
            }
        }
    ...
    // draggable
    (0, _interact2.default)('.rcbrowser-header').draggable({
    ...
    function setRCBAnchor() {
        var openButton = document.querySelectorAll('.rcbrowser__open-button');
        var closeButton = document.querySelectorAll('.rcbrowser__close-button');
        var rcBrowsers = document.querySelectorAll('.rcbrowser');
        ...
        function clickOpenHandler(e) {
            ...
            for (var i = 0, len = rcBrowsers.length; i < len; i += 1) {
                ...
                if (id === targetId) {
                    ...
                    for (var _i25 = 0, _len25 = rcBrowsers.length; _i25 < _len25; _i25 += 1) {
                        rcBrowsers[_i25].removeClass('js-rcb-current-active');
                    }
        ...
        for (var _i26 = 0, _len26 = openButton.length; _i26 < _len26; _i26 += 1) {
            openButton[_i26].addEventListener('click', clickOpenHandler);
        }
        for (var _i27 = 0, _len27 = closeButton.length; _i27 < _len27; _i27 += 1) {
            closeButton[_i27].addEventListener('click', clickCloseHandler);
        }
    }
    setRCBAnchor();
    ...
    (function () {
        var rcBrowser = document.querySelector('.rcbrowser--your-qa');
        var container = document.querySelector('.rcbrowser-main-body--your-qa');
        var anchor = document.querySelector('.see-all-notifications');
        var notifications = [].slice.call(document.querySelectorAll('.notifications-item'));
        var notificationsList = [];
        var docFragment = document.createDocumentFragment();

        for (var i = 0; i < 4; i += 1) {
            for (var _i28 = 0, len = notifications.length; _i28 < len; _i28 += 1) {
                notificationsList.push(notifications[_i28]);
            }
        }
        ...
        function clickHandler(e) {
            ...
            setTimeout(function () {
                var notificationsListLength = notificationsList.length;
                for (var _i29 = 0; _i29 < notificationsListLength; _i29 += 1) {
                    ...
                    elementContainer.innerHTML = notificationsList[_i29].innerHTML;
    ...
    (function () {
        var rcBrowsers = document.querySelectorAll('.rcbrowser');
        var openButtons = document.querySelectorAll('.add-reward-button');
        var closeButtons = document.querySelectorAll('.add-reward__close-button');
        ...
        function clickHandler() {
            ...
            var container = currentBrowser.querySelector('.add-reward-container');
        ...
        for (var i = 0, len = openButtons.length; i < len; i += 1) {
            openButtons[i].addEventListener('click', clickHandler);
        }

        for (var _i30 = 0, _len28 = closeButtons.length; _i30 < _len28; _i30 += 1) {
            closeButtons[_i30].addEventListener('click', clickHandler);
        }
    })();
    ...
    (function () {
        function loadHandler() {
            (0, _imagesloaded2.default)(document.getElementById('cover'), { background: true }, function () {
    ...
    // loadmore loading
    (function () {
        var elements = document.querySelectorAll('.loadmore-button');
    ...
    (function () {
        ...
        function clickHandler(e) {
            ...
            var targetPosition = target === 'html' ? 0 : document.querySelectorAll(target)[0].getBoundingClientRect().top + window.pageYOffset;
            _gsap.TweenLite.to(window, duration, { scrollTo: { y: targetPosition, autoKill: true }, ease: _gsap.Power3.easeOut });
        }
    ...
    (function () {
        ...
        var reslutNumberElement = document.getElementById('result-number');
        var timer = null;
...
},{"../../../node_modules/gsap/src/uncompressed/plugins/ScrollToPlugin.js":5,"gsap":3,"imagesloaded":6,"interact.js":7,"perfect-scrollbar":8}],2:[function(require,module,exports){
/**
 * EvEmitter v1.0.3
 * Lil' event emitter
 * MIT License
...
},{"./src/js/main":14}],9:[function(require,module,exports){
'use strict';
...
},{"../instances":25,"../update-geometry":26,"../update-scroll":27}],18:[function(require,module,exports){
'use strict';
...
},{"../../lib/dom":10,"../../lib/helper":13,"../instances":25,"../update-geometry":26,"../update-scroll":27}],20:[function(require,module,exports){
'use strict';
...
},{"../../lib/helper":13,"../instances":25,"../update-geometry":26,"../update-scroll":27}],24:[function(require,module,exports){
'use strict';
...
},{"../lib/class":9,"../lib/dom":10,"../lib/event-manager":11,"../lib/guid":12,"../lib/helper":13,"./default-setting":15}],26:[function(require,module,exports){
'use strict';
...
},{"../lib/dom":10,"../lib/helper":13,"./instances":25,"./update-geometry":26,"./update-scroll":27}]},{},[1]);
